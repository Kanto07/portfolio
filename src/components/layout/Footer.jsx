  ...
  return (
    <footer className="relative mt-24 border-t border-white/10 bg-[#050505] overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-10">
        <div className="flex sm:flex-col flex-row items-center justify-between gap-8">
          {/* left */}
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500 text-center">
            ...
            <span className="block">Tous droits réservés.</span>
          </div>
        ...
        {/* bottom */}
        <div className="mt-8 sm:mt-2 pt-6 border-t border-white/5 flex items-center justify-center gap-2 text-xs text-gray-600">
