...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Développement d'un site vitrine moderne pour un salon de coiffure en Belgique (Style Bruxelles Palermo) avec optimisation responsive et intégration d'une interface élégante.",
